...
document.writeln('</script>');
document.writeln('<script src="" type="text/javascript"></script></div>');


//document.writeln("<div align=\"center\"><p style=\"font-size:14px;\">==如非特殊说明，素材均转载自网络，如侵犯了你的知识产权，请邮件联系：443278896@qq.com，我们会尽快处理！==</p></div>");

*/
//////////////////////////////////////////////////////以下保留

document.write(
    '<div style="display:none"><script language="javascript" type="text/javascript" src="//js.users.51.la/16741667.js"></script></div>'
);
document.write(
    '<div style="display:none"><script language="javascript" type="text/javascript" src="//js.users.51.la/17278758.js"></script></div>'
);
